...
* 💻 HTML5, CSS3, Bootstrap, Tailwind CSS, JavaScript, Node JS, Python, R, Java, SQL, JSON
...
- 👨🏻‍💻 [Restaurant Management NodeJS-API](https://github.com/akhilchandran1/Restaurant-Management-NodeJS-API)
